...
public class SerializableClass {
    public static void main(String[] args) {
        ...
        try {
            ObjectOutputStream writting_file = new ObjectOutputStream(new FileOutputStream("C:/Users/kenisito/Desktop/java_ser/employee.txt"));
            writting_file.writeObject(personal);
            writting_file.close();
